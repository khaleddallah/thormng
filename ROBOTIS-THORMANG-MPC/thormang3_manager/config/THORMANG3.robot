...
/dev/ttyUSB0 | 1000000  | l_leg_kn_p
...
#dynamixel | /dev/ttyUSB3 | 20  | MX-64 | 1.0      | l_leg_hip_p  | present_position, present_voltage
#dynamixel | /dev/ttyUSB2 | 21  | H54-200-S500-R | 2.0      | r_leg_kn_p   | present_position, present_voltage
dynamixel | /dev/ttyUSB0 | 12  | MX-64 | 1.0      | l_leg_kn_p   | present_position, present_voltage
...
dynamixel | /dev/ttyUSB0 | 10  | MX-64 | 1.0      | l_leg_an_p   | present_position, present_voltage, external_port_data_1, external_port_data_2
...
dynamixel | /dev/ttyUSB0 | 9  | MX-64 | 1.0      | l_leg_an_r   | present_position, present_voltage, external_port_data_1, external_port_data_2, external_port_data_3, external_port_data_4
